...
- **GitHub Security Advisory:** [Create advisory](https://github.com/myveisun/myweixiaomi/security/advisories/new)
...
Weixiaomi (威小蜜AI) is a self-hosted control plane. Operators are responsible for:
